...
<div class="row" style="background-color: rgba(0, 0, 0, 0.804); color:azure; margin-top: 30vh;">
    <div class="page header">
        <h1 style="text-align: center;font-family: 'Century Gothic', cursive;">Billing List</h1>

    
</div>
    <table id="myTable" class="table table-bordered animated slideInLeft" >  
